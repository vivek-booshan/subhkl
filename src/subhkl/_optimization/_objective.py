# NOTE: internal objective specifically for minimize.py
# This only takes state, rcfg, icfg as input.
# Use subhkl.optimization.VectorizedObjective for unit testing or direct access
